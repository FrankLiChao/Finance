...
//@property (nonatomic, strong) UIImageView *desImgView;//描述
...
- (UIImageView *)logoImgView
{
    if (!_logoImgView) {
        ...
        UIImageView *logo = [[UIImageView alloc] initWithFrame:CGRectMake((DeviceMaxWidth-60*widthRate)/2, 0, 60*widthRate, 18*widthRate)];
        logo.image = imageWithName(@"refreshLogo");
        [self addSubview:_logoImgView = logo];
    }
...
//    if (!_desImgView) {
//        
//        UIImageView *des = [[UIImageView alloc] initWithFrame:CGRectMake((DeviceMaxWidth-236*widthRate)/2, 0, 236*widthRate, 10*widthRate)];
//        des.image = imageWithName(@"refreshDescription");
//        [self addSubview:_desImgView = des];
//    }
//    
//    return _desImgView;
//}
...
+ (instancetype)header
{
    MJRefreshHeaderView * h = [[MJRefreshHeaderView alloc] init];
    h.isHeader = YES;
    return h;
}
...
//    CGFloat statusX = 0;
    ...
    CGRect rec = self.logoImgView.frame;
    rec.origin.y = statusY;
    self.logoImgView.frame = rec;
...
//    self.statusLabel.hidden = YES;
    ...
    // 1.状态标签
    self.statusLabel.frame = CGRectMake((DeviceMaxWidth-236*widthRate)/2, lastUpdateY-5*widthRate, 236*widthRate, 20*widthRate);
    
//    CGRect rec1 = self.desImgView.frame;
//    rec1.origin.y = lastUpdateY;
//    self.desImgView.frame = rec1;
