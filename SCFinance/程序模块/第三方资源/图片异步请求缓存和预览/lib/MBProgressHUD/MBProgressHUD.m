...
//	CGSize labelSize = [label.text sizeWithFont:label.font];
    CGSize labelSize = [lhUtilObject sizeWithFontWhenIOS7:label.text font:label.font];
...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    ...
    CGSize detailsLabelSize = [lhUtilObject sizeWithFontWhenIOS7:detailsLabel.text font:detailsLabel.font constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
